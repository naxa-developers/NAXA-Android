                    ...
                    public void onComplete(@NonNull Task<Location> task) {
                        if (task.isSuccessful()) {
                            ...
                            if (mLastKnownLocation != null) {
                                ...
                                longititude = mLastKnownLocation.getLongitude();
                            }
                            mMap.moveCamera(CameraUpdateFactory.newLatLngZoom(

                                    new LatLng(latitude,
                                            longititude), DEFAULT_ZOOM));
                        } else {
...
/*
    ...
    public void onPolylineClick(Polyline polyline) {
        ...
        Toast.makeText(getApplicationContext(), "Area of Polyline" + SphericalUtil.computeArea(latLngs), Toast.LENGTH_LONG).show();
        LatLng latLng = new LatLng(51.8393728, -8.491865);
        LatLng latLng1 = new LatLng(100.01, -100);
        Toast.makeText(getApplicationContext(), "Area of polyline" + SphericalUtil.computeDistanceBetween(latLng, latLng1), Toast.LENGTH_LONG).show();
    }*/
